...
def delete_credential(credential):
    '''
    Function that delete a saved credential
    ...
    while True:
        ...
        ex - exit Credentials''')
                    ...
                    if short_code == 'cc':
                        ...
                        print("\n")
                        print(f"Credentials for {credential_name} with password {(create_generated_password(credential_name))} have been created and saved")
                        print("\n")

                    elif short_code == 'del':
                        print(f"enter the name of the credential you want to remove")
                        search_name=input()
